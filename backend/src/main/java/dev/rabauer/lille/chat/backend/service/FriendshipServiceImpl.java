...
public class FriendshipServiceImpl implements FriendshipService {
    ...
    public FriendshipDto sendRequest(UUID requesterId, UUID addresseeId) {
        ...
        friendshipRepository.findExistingFriendship(requesterId, addresseeId)
                .ifPresent(f -> {
    ...
    public FriendshipDto acceptRequest(UUID friendshipId, UUID userId) {
        ...
        if (!friendship.getAddressee().getId().equals(userId)) {
            throw new IllegalArgumentException("Only the addressee can accept the friend request");
        }
    ...
    public FriendshipDto declineRequest(UUID friendshipId, UUID userId) {
        ...
        if (!friendship.getAddressee().getId().equals(userId)) {
            throw new IllegalArgumentException("Only the addressee can decline the friend request");
        }
